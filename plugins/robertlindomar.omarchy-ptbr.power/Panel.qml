...
Panel {
  ...
  function profileDisplayLabel(name) {
    return Model.profileDisplayLabel(name)
  }

  readonly property string heroStatusText: {
    if (fullyCharged) return "Totalmente carregada"
      ...
      Column {
        ...
        Row {
          ...
          Column {
            ...
            InfoPair { label: "Capacidade"; value: root.batteryInfo.size || "" }
          ...
          Column {
            ...
            spacing: Style.spacing.labelGap
            InfoPair {
              label: root.chargeThresholdActive ? "Limite de carga" : (root.discharging ? "Tempo restante" : "Tempo até carga completa")
              value: root.chargeThresholdActive ? (root.batteryInfo.threshold || "-") : (root.batteryFlowIdle ? "-" : (root.batteryInfo.time || "—"))
            }
            InfoPair {
              label: root.chargeThresholdActive ? "Estado da bateria" : (root.discharging ? "Descarregando" : "Carregando")
              value: root.chargeThresholdActive ? "Em espera" : (root.batteryFull ? "-" : (root.batteryInfo.rate || ""))
            }
          }
        }
          ...
          Row {
            ...
            Repeater {
              ...
              Button {
                ...
                text: root.profileDisplayLabel(String(modelData))

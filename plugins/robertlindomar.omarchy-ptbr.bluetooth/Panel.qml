...
Panel {
  ...
  readonly property string toggleHint: root.adapter && root.adapter.enabled ? "Desativar Bluetooth" : "Ativar Bluetooth"
  ...
  function scrollSectionTitle(index) {
    ...
    return Model.scrollSectionTitle(rows[index].section)
  }
      ...
      Column {
        ...
        Text {
          ...
          text: !root.adapter ? "Nenhum adaptador Bluetooth"
              : !root.adapter.enabled ? "Ative o Bluetooth para procurar dispositivos"

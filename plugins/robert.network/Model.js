...
function dnsProviderTooltip(provider) {
  switch (provider) {
  case "DHCP":
    return "Usar DNS do DHCP"
  case "Cloudflare":
    return "Definir DNS para Cloudflare"
  case "Google":
    return "Definir DNS para Google"
  case "Custom":
    return "Definir servidores DNS personalizados"
  default:
    return ""
  }
}
...
// instead -- "BANDA WI-FI: 2.4GHZ". Once a band is pinned the pills are on
...
if (typeof module !== "undefined") {
  module.exports = {
    ...
    bandLabel: bandLabel,
    dnsProviderLabel: dnsProviderLabel,
    dnsProviderTooltip: dnsProviderTooltip,

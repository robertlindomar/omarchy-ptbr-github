...
Panel {
  ...
  readonly property string toggleHint: Networking.wifiEnabled ? "Desativar Wi-Fi" : "Ativar Wi-Fi"
      ...
      Item {
        ...
        RowLayout {
          ...
          Button {
            ...
            iconText: "󰓅"
            tooltipText: "Executar teste de velocidade"
            foreground: root.bar.foreground
            fontFamily: root.bar.fontFamily
            iconSize: Style.font.subtitle * 1.5
            horizontalPadding: Style.space(5)
      ...
      Column {
        ...
        Row {
          ...
          DnsProviderPill {
            provider: "DHCP"
            index: 0
            tooltipText: Model.dnsProviderTooltip("DHCP")
          ...
          DnsProviderPill {
            provider: "Cloudflare"
            index: 1
            tooltipText: Model.dnsProviderTooltip("Cloudflare")
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
          ...
          DnsProviderPill {
            provider: "Google"
            index: 2
            tooltipText: Model.dnsProviderTooltip("Google")
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
          ...
          DnsProviderPill {
            provider: "Custom"
            index: 3
            tooltipText: Model.dnsProviderTooltip("Custom")
            width: dnsRow.cellWidth
            onClicked: root.setDns(provider)
          }
        }
  ...
  component DnsProviderPill: Button {
    ...
    text: Model.dnsProviderLabel(provider)
    fontSize: Style.font.bodySmall
    foreground: root.bar.foreground
    fontFamily: root.bar.fontFamily
    horizontalPadding: Style.spacing.controlPaddingX
  ...
  component DetailValue: InfoValue {
    ...
    property string tooltipText: "Copiar para a área de transferência"

    ...
    BorderSurface {
      ...
      Item {
        ...
        ConfirmDialog {
          ...
          z: 10
          message: "Excluir todo o histórico da área de transferência?"
          cancelText: "Cancelar"
          confirmText: "Excluir"
      ...
      Column {
        ...
        Rectangle {
          ...
          Text {
            ...
            text: root.filterText || "Pesquisar área de transferência…"
        ...
        Item {
          ...
          Column {
            ...
            Text {
              textFormat: Text.PlainText
              text: root.history.length === 0 ? "Área de transferência vazia" : "Nenhum resultado para “" + root.filterText + "”"
              color: root.foreground
              opacity: 0.7
              font.family: root.fontFamily
              font.pixelSize: Style.font.title

...
Panel {
  ...
  // Abreviações de dia via Qt.locale; mês/hero via Model.js (formatDate+locale falha no shell).
  readonly property var labelLocale: Qt.locale("pt_BR")
  readonly property string nextWeekStartLabel: Model.weekdayLongName(Model.toggledWeekStart(weekStart))
          ...
          Item {
            ...
            Row {
              ...
              Text {
                ...
                text: Model.heroDateLabel(root.today)
                color: heroMouse.containsMouse
                  ? Style.hoverStateColor(root.contentForeground, Color.accent)
                  : root.contentForeground
                font.family: root.contentFontFamily
              ...
              Row {
                ...
                Rectangle {
                  ...
                  PanelToolTip {
                    ...
                    text: "Iniciar semanas na " + root.nextWeekStartLabel
                    fontFamily: root.contentFontFamily
                  }
                }
          ...
          Item {
            ...
            Item {
              ...
              Text {
                ...
                horizontalAlignment: Text.AlignHCenter
                text: Model.monthYearLabel(root.viewYear, root.viewMonth)
